...
<head>
    ...
    <title>قالب مدیریتی مدیر من - قالب چند منظوره فوق حرفه ای - ساخته شده با بوت استرپ ورژن 4</title>
    <!-- Bootstrap Core CSS -->
...
<div class="preloader">
    ...
    <!-- ============================================================== -->
    <section id="wrapper">
        <div class="login-register" style="background-image:url(Content/img/blog-bg2.jpg);">
                ...
                <div class="card-body">
                    <form class="form-horizontal form-material" id="loginform" method="POST"
                        ...
                        <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                            <div class="col-xs-12">
                                <input class="form-control" value="{{ old('email') }}" type="text" name="email" required placeholder="نام کاربری "></div>
                                @if ($errors->has('email'))
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <a href="javascript:void(0)" id="to-recover" class="text-dark pull-right"><i
                                            class="fa fa-lock m-r-5"></i> فراموشی رمز؟</a></div>
                        </div>
                    ...
                    <form class="form-horizontal" id="recoverform" method="POST" action="{{ route('password.request') }}">
                        ...
                        <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                            <div class="col-xs-12">
                                <input class="form-control" name="email" value="{{ $email or old('email') }}" required autofocus type="email"  placeholder="ایمیل"></div>
                        </div>
                        <div class="form-group text-center m-t-20">
                            <div class="col-xs-12">
