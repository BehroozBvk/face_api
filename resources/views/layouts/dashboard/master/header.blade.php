            ...
            <div class="navbar-header">
                <a class="navbar-brand" href="{{route('admin.index')}}">
                    ...
                    <b>
                        ...
                        <!-- Dark Logo icon -->
                        <img src="{{asset('assets/images/logo-icon.png')}}" width="34" height="30" alt="homepage" class="dark-logo" />
                        <!-- Light Logo icon -->
                    ...
                    <span>
                        ...
                        تشخیص چهره
                        <!-- Light Logo text -->
                         <img src="{{asset('assets/images/logo-light-icon.png')}}" class="light-logo" alt="homepage" /></span> </a>
            </div>
            <!-- ============================================================== -->
            <!-- End Logo -->
            <!-- ============================================================== -->
